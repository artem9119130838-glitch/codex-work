...
1.  **[windows](file:///C:/Users/Артем/.gemini/config/skills/windows/SKILL.md) — Диагностика Windows и миграция окружения**
    *   *Когда вызывать:* Зависание Acrobat Reader, проблемы блокировки PDF в Temp, медленная работа Проводника (Explorer), сбои реестра, .bat скрипты, Punto Switcher, гибридная графика Intel/NVIDIA и черный экран, управление BCD и Safe Mode (клавиша F8, msconfig), миграция и синхронизация между Victus и MateBook, генерация конфигураций FreeFileSync (`.ffs_gui`), адаптация путей Antigravity.
...
12. **[n8n_crm_diagnostics](file:///C:/Users/Артем/.gemini/config/skills/n8n_crm_diagnostics/SKILL.md) — Диагностика n8n и CRM**
    *   *Когда вызывать:* Ускоренная диагностика сбоев в n8n сценариях, проверка зависших executions, работоспособности API-ключей (Bitrix24, Gemini, 1C), сжатие SQLite без WAL и быстрая диагностика диска.
