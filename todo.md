...
- [x] Проверка безопасности инфраструктуры VPS в связи с увольнением Михаила (блокировка VPN WireGuard 10.10.0.6, удаление туннеля Bore, очистка зашитого ключа DeepSeek в коде) и создание карты архитектуры сети docs/ARCHITECTURE_MAP.md на VPS.
