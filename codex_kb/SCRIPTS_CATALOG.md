...
> **Дата последней автоматической ревизии:** `2026-09-25 13:27:20`  
> **Статус контура:** Уникальных проверенных скриптов: `479` | Отсеяно дубликатов: `595` | Библиотек вендоров: `4385`.  
...
- [1. CRM Битрикс24 (Чаты, Сделки, Лиды, Задачи, Вебхуки)](#b24)
- [2. 1С:УНФ и OData API (Контрагенты, Заказы, Номенклатура)](#1c)
- [3. Почта (IMAP / SMTP / Обработка писем и вложений)](#email)
- [4. HR, Резюме и Кандидаты (Китай / ВЭД)](#hr)
- [5. Тендеры, АСТ ГОЗ и RAG-пайплайн спецификаций](#tender)
- [6. Инфраструктура, VPS-сервер, Docker и Бэкапы](#infra)
- [7. Windows, HP Victus 16, Дисплеи и Safe Mode](#windows)
- [8. Управление сессиями и сжатие ИИ-контекста](#session)

---

<a id='b24'></a>
## 1. CRM Битрикс24 (Чаты, Сделки, Лиды, Задачи, Вебхуки)
...
<a id='1c'></a>
## 2. 1С:УНФ и OData API (Контрагенты, Заказы, Номенклатура)
...
<a id='email'></a>
## 3. Почта (IMAP / SMTP / Обработка писем и вложений)
...
<a id='hr'></a>
## 4. HR, Резюме и Кандидаты (Китай / ВЭД)
...
<a id='tender'></a>
## 5. Тендеры, АСТ ГОЗ и RAG-пайплайн спецификаций
...
<a id='infra'></a>
## 6. Инфраструктура, VPS-сервер, Docker и Бэкапы
...
<a id='session'></a>
## 8. Управление сессиями и сжатие ИИ-контекста
