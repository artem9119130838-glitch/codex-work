 ...
 */
    ...
    (() => {
        ...
        class Popup {
            ...
            close(selectorValue) {
                ...
                if (!this._reopen) {
                    ...
                    bodyUnlock();
                    this.isOpen = false;
                } else !this.bodyLock ? bodyUnlock() : null;
                this._removeHash();
        ...
        let tippies = document.querySelectorAll(".specialists-financing__tippy");
        for (let i = 0; i < tippies.length; i++) {
            let tipp = tippies[i];
            let hint = tipp.querySelector(".specialists-financing__hint").innerHTML;
            tippy_esm(tipp, {
                content: hint,
                theme: "light",
                placement: "right"
        ...
        if (document.querySelector(".services__slider")) {
            ...
            function breakpointChecker() {
                if (breakpoint.matches) modelSlider = new core(".services__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
                    ...
                    on: {}
                }); else if (void 0 !== modelSlider) modelSlider.destroy(true, true);
            }
            breakpoint.addEventListener("change", breakpointChecker);
            breakpointChecker();
        }
        function initSliders() {
            if (document.querySelector(".trust-main__slider")) new core(".trust-main__slider", {
                ...
                navigation: {
                    prevEl: ".trust-main__btn-prev",
                    nextEl: ".trust-main__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".real-projects__slider")) new core(".real-projects__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".real-projects__btn-prev",
                    nextEl: ".real-projects__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".complex-services__slider")) new core(".complex-services__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                speed: 800,
                ...
                navigation: {
                    prevEl: ".complex-services__btn-prev",
                    nextEl: ".complex-services__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".production-brevini__slider")) new core(".production-brevini__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                ...
                navigation: {
                    prevEl: ".production-brevini__btn-prev",
                    nextEl: ".production-brevini__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".sertificates-company__slider")) new core(".sertificates-company__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                slidesPerView: "auto",
                navigation: {
                    prevEl: ".sertificates-company__btn-prev",
                    nextEl: ".sertificates-company__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".thanks-about__slider")) new core(".thanks-about__slider", {
...
***************************************************************************** */
        ...
        da.init();
        document.querySelector(".menu__drop-arrow");
        const menuItemServices = document.querySelectorAll(".menu__item--hassub");
        document.addEventListener("click", documentActions);
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".menu__drop-arrow")) {
                menuItemServices.forEach((menuItemService => {
                    if (menuItemService != targetElement.closest(".menu__item--hassub.menu-item-depth-0") && menuItemService != targetElement.closest(".menu__item--hassub.menu-item-depth-1")) if (menuItemService.classList.contains("_active")) menuItemService.classList.remove("_active");
                }));
                if (!targetElement.closest(".menu__item--hassub.menu-item-depth-1")) targetElement.closest(".menu__item--hassub.menu-item-depth-0").classList.toggle("_active"); else targetElement.closest(".menu__item--hassub.menu-item-depth-1").classList.toggle("_active");
            }
            if (!targetElement.closest(".menu__item--hassub.menu-item-depth-0") && !targetElement.closest(".menu__item--hassub.menu-item-depth-1")) menuItemServices.forEach((menuItemService => {
                if (menuItemService.classList.contains("_active")) menuItemService.classList.remove("_active");
            }));
        }
        let toTop = document.querySelector(".btn-totop");
        document.addEventListener("windowScroll", (function(e) {
            let scrollTop = window.scrollY;
            if (scrollTop > 200) toTop.style.display = "flex"; else toTop.style.display = "none";
        }));
        let script_scrollTop = window.scrollY;
        if (script_scrollTop > 200) toTop.style.display = "flex"; else toTop.style.display = "none";
        isWebp();
        menuInit();
        spollers();
        pageNavigation();
