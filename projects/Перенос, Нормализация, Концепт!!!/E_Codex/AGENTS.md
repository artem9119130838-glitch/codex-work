...
Do not treat old chat exports as the first source of truth unless the current KB points there for detail. The old exports are preserved under `E:\Codex_Work\chat_exports`.
...
- Put old one-off files under `E:\Codex_Work\Архив`.
