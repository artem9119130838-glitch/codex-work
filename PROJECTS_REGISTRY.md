...
Registry of active projects under `E:\Codex_Work\projects`.

| project | status | path | handoff | next action |
|---|---|---|---|---|
| 1c_odata | active | $projPath | $handoff | Review handoff + define next step |
| bitrix | active | $projPath | $handoff | Review handoff + define next step |
| local_inventory | active | $projPath | $handoff | Review handoff + define next step |
